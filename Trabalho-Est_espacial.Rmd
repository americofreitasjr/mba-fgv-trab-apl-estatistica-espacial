...
plot(density.ppp(Houston_Rape_ppp, sigma=raio_Rape.est, kernel="gaussian"), main="Sigma=0.002992444 (Rape) ",cex.main=0.002)
...
mtext("Teste CSR com Método da Quadratura", outer=TRUE ,side = 3,line=-2, cex = 1.4)
par(mfrow=c(1,1))
...
mtext("Teste CSR com Método Qui-quadrado", outer=TRUE ,side = 3,line=-2, cex = 1.4)
par(mfrow=c(1,1))
```
